                        ...
                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    user.put("balance", 0);
                                    user.put("points", 0);
                                    user.put("username", usernameDb);
                                    user.put("numOfTransaction", 0);
                                    user.put("sessionStarted", false);
                                    user.put("userType", "");
                                    user.put("Mobile", "");
                                    ...
                                    //transaction.put("transaction", 1);

                                    //userRef.document(userid).collection("Transaction").add(transaction);
