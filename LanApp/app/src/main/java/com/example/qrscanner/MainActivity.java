...
*/
    ...
    public void onResume() {
        ...
        viewModel.getBalanceData().observe(this, data -> {
            balanceValue = data;
            balanceText.setText(String.format("Balance: $%.2f", data));
            //balanceText.setText(String.format("Balance: $" + data.toString()));
        });
        //balanceText.setText(String.format("Balance: $%.2f", balanceValue));
        System.out.println("MainActivity Balance: " + balanceValue);
