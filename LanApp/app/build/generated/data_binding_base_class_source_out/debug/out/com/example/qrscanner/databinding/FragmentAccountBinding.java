...
public final class FragmentAccountBinding implements ViewBinding {
  ...
  private FragmentAccountBinding(@NonNull FrameLayout rootView, @NonNull Toolbar homeToolbar) {
  ...
  public static FragmentAccountBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAccountBinding((FrameLayout) rootView, homeToolbar);
    }
